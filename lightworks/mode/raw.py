...
def get_parser():
  ...
  parser.add_option('', "--help", dest="help", action="store_true", help="Show raw options")
  parser.add_option("-l", "--list", dest="list_raw", action="store_true", help="List raw files")
